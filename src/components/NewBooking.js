...
export default function NewBooking() {
  ...
  useEffect(() => {
    axios.get("https://peaceful-beach-25534.herokuapp.com/api/v2/booking/search/"+email).then((res) => {
      if (res.data == 0) {
        console.log("no data");
      } else {
  ...
  const onSubmit = () => {
    ...
    axios
      .post("https://peaceful-beach-25534.herokuapp.com/api/v2/booking/add", booking_data)
      .then((res) => {
        alert("booking done");
  ...
  return (
    <>
      ...
      {!token && !role ? (
        (window.location = "https://peaceful-beach-25534.herokuapp.com/api/v2/users/login")
      ) 
      : isBooked2 ? (
        <>
          <div>
